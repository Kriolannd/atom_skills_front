...
let routerParam = router.currentRoute.value.params.code
  getLesson(Array.isArray(routerParam) ? routerParam[0] : routerParam).then(
    response => {
      ...
      someLessonData1 = [someLessonData.value.title, someLessonData.value.author]
      console.log(someLessonData1);
    }
  ).catch(
    error => {
      console.log(error)
...
<template>
    <div class="task-container">
        ...
        <div class="lesson-sidebar">
            <DataView dataKey="value" :value="someLessonData1" paginator :rows="3">
            ...
            <ScrollPanel style="width: 100%; height: 100%">
                ...
                <div class="task-button-container">
                    <div class="card flex justify-center flex-wrap gap-4">
                        <Button label="Кнопка 1" severity="success" raised />
                        <Button label="Кнопка 2" severity="success" />
                        <Button label="Кнопка 3" severity="success" />
                    </div>
                </div>
            </ScrollPanel>
        </div>
        </div>
        <Button id="b1" icon="pi pi-refresh" rounded raised @click="router.push('lessons')" />
    </div>
</template>
